...
CUDA_VISIBLE_DEVICES=0 python scripts/run_control.py --multirun hydra.job.name=rd_case_study \
...
# # for robosuite
# CUDA_VISIBLE_DEVICES=0 python scripts/run_control.py --multirun hydra.job.name=rs_case_study \
